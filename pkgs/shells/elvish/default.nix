...
buildGoModule rec {
  pname = "elvish";
  version = "unstable-2021-03-28g${builtins.substring 0 9 src.rev}";
  ...
  src = fetchFromGitHub {
    owner = "elves";
    repo = pname;
    rev = "29034c20e9a30e9826c9f9aeac309b4d519db08e";
    sha256 = "12j518wbphzy043c6fp0zb1fr7x0qpx8sb44gbk9fn6i3j4z0w2i";
  };
