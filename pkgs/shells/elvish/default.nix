...
buildGoModule rec {
  pname = "elvish";
  version = "unstable-2022-08-13g${builtins.substring 0 9 src.rev}";
  ...
  src = fetchFromGitHub {
    owner = "elves";
    repo = pname;
    rev = "7c755104071ad89b578c1d491ac1565f53f9a5c6";
    sha256 = "1cd5z60ibyaaka841hnxm33p7yxrnqkgiylcjy990b0ha8q1frqy";
  };
